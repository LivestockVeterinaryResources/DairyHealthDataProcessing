...
1.  The events_formatted.parquet file is read in, named "events",  and filtered for health events. Filter this further so you only have only one or 2 unique health events that are interesting to you.  The example in the solution is based on 'NAVEL' and 'SEPTIC' events, but choose anything you want. If it is not NAVEL and SEPTIC don't worry about the solutions not matching in this milestone.
