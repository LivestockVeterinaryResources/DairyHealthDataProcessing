...
source(file.path("functions/fxn_event_type.R")) # c function to categorize events
source(file.path("functions/fxn_location.R")) # custom function to specify event location
...
list_files <- list.files(file.path("data/milk_files")) # folder name where event files are located
...
# fix column names----------------------
source(file.path("functions/fxn_fix_item_names_prod.R"))
