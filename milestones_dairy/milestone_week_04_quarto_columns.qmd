...
In this milestone, you'll create a new variable that classifies the execution outcome of each BRED1. You'll then compute the change in GFR over time for each stage and patient group. 
